<?php
/**
 * plugin de joomla llamado profile, especificamente del tipo user, lo que significa que amplia o modifica el comportamiento de los formularios y datos de usuario dentro del sistema.
 * añade campos adicionales al perfil de usuario en joomla.
 * puede ser utilizado en los formularios de:
 * registro
 * edicion de usuario
 * perfil de usuario
 * perfil de administrador
 * 
 * este plugin añade campos personalizados, es decir como si fueran una plantilla de formularios de bootstrap
